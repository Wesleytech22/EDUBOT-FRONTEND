...
// Tela 07 — Painel Escolar (RF-33 a RF-36): a restrição do produto aparece
// antes dos dados — a plataforma lê a planilha, nunca escreve nela.
// Sprint 06: depende de GET/POST /api/students* (Google Sheets), ainda não
// implementados no backend. Ainda não ligada em App.jsx/Sidebar.
    ...
    <Layout title="Painel Escolar">
      ...
      <div className="card">
        ...
        <p className="opp-hint">
          RF-34 · nome, série, presenças/faltas, frequência calculada, situação e última atualização
        </p>
